...
describe('api directives @model @key @connection @versioned', () => {
  ...
  it('connection-alternative limit', async () => {
    const testresult = await testSchema(projectDir, 'connection-alternative', 'limit');
    expect(testresult).toBeTruthy();
  });

  it('connection-alternative manyToMany', async () => {
    const testresult = await testSchema(projectDir, 'connection-alternative', 'manyToMany');
    expect(testresult).toBeTruthy();
  });

  it('connection-alternative named', async () => {
    const testresult = await testSchema(projectDir, 'connection-alternative', 'named');
    expect(testresult).toBeTruthy();
  });

  it('connection-alternative unnamed-oneToMany', async () => {
    const testresult = await testSchema(projectDir, 'connection-alternative', 'unnamed-oneToMany');
    expect(testresult).toBeTruthy();
  });

  it('connection-alternative unnamed-oneToOne', async () => {
    const testresult = await testSchema(projectDir, 'connection-alternative', 'unnamed-oneToOne');
    expect(testresult).toBeTruthy();
  });
